<script>
  ...
  let benefits = [
    {name:'a self taught developer', description: 'I\'m a self-taught developer with a deep passion for technology and continuous learning. My journey in the tech world began with a curiosity for problem-solving and has evolved into a robust skill set that spans multiple programming languages and frameworks.'},
    ...
    {name:'an excellent communicator', description: 'Communication is key and it\'s a paramount value of mine. I believe in transparency and constructive communication above all else. This helps me develop deep relationships and ensures my effectiveness and productivity in any workspace with any team.'},
  ]
</script>
...
<section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
  ...
  <a href="https://github.com/CAUCORASEKO"
      target="_blank" class="mx-auto px-4 py-2 rounded-md fa-border
      border-solid border-white flex items-center gap-2 -mb-4 sm:-mb:-mb-0
...
<section 
  id="about" 
  class="py-20 pt-10 lg:pt-16 lg:py-32 flex-col gap-16 sm:gap-20 md:gap-24 relative">
  ...
  <p class="mx-auto poppins font-semibold text-lg sm:text-xl md:text-2xl">Hi I'm ... </p>
